...
public class MyScrumTeam {
    public static void main(String[] args) {
      // 3 testers  objects
        ...
        Developer developer3=new Developer("Tunc",28,"Sofetware Developer",135000);
        ...
        scrum.addDevelopers(developers);//(developers) all the developers in the array
        ...
        System.out.println("--------------------------");
        scrum.removeTester(23);// this tester will be removed
