...
public class ScrumTeam {
    ...
    public void removeTester(int employeeID){
        testersList.removeIf(p->p.employeeID==employeeID);// can remove only one ID, name might be same but id is always unique
    }
    ...
    public String toString() {
        return "ScrumTeam{" +
                ...
                ", BA='" + BA + '\'' +
                ", SM='" + SM + '\'' +
                ", total number of testersList=" + testersList .size()+
                ", total number of developersList=" + developersList.size() +// size will give the number of
