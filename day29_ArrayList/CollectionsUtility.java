...
public class CollectionsUtility {
    public static void main(String[] args) {
      ...
      int max=Collections.max(list3);
        ...
        int coutnJava=Collections.frequency(words,"Java");
        int coutnPython=Collections.frequency(words,"Python");
        System.out.println("coutnPython = " + coutnPython);
        System.out.println("coutnJava = " + coutnJava);
    }
}
